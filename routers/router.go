...
func init() {
	...
	beego.Router("/productos/:id:int", &controllers.ProductoController{}, "put:Put;delete:Delete;get:GetOne")
	beego.Router("/consumidores", &controllers.ConsumidorController{}, "post:Post;get:Get")
	beego.Router("/consumidores/:id:int", &controllers.ConsumidorController{}, "put:Put;delete:Delete;get:GetOne")
